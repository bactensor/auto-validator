# Generated by Django 4.2.15 on 2024-09-01 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("maximum_registration_price", models.IntegerField(default=0)),
                ...
                (
                    "subnet",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="slots", to="core.subnet"
                    ),
                ),
            ],
        ),
